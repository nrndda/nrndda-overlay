...
inherit eutils toolchain-funcs qt4-r2 systemd multilib git-2
...
SLOT="0"
KEYWORDS=""
IUSE="dbus debug doc gnutls eap-sim fasteap madwifi ps3 qt4 readline selinux ssl wimax wps kernel_linux kernel_FreeBSD"
...
src_configure() {
	...
	if use qt4 ; then
		pushd "${MY_S}"/wpa_gui-qt4 > /dev/null
		eqmake4 wpa_gui.pro
		popd > /dev/null
	fi
}
