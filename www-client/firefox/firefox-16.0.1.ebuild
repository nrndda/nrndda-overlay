...
src_prepare() {
	rm ${WORKDIR}/firefox/{1001-fix_jemalloc_vs_aslr.patch,2000-firefox_gentoo_install_dirs.patch,6007_dont_hardcode_page_size.patch,7002_freebsd_ipc_support.patch}
	# Apply our patches
	EPATCH_SUFFIX="patch" \
	EPATCH_FORCE="yes" \
