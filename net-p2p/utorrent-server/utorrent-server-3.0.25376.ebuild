...
V_1=$(get_major_version)
V_2=$(get_version_component_range 2)
V_3=$(get_version_component_range 3)
MY_PV="$V_1.$V_2-ubuntu-$V_3"

DESCRIPTION=""
HOMEPAGE="http://www.utorrent.com/linux"
SRC_URI="http://download.utorrent.com/linux/${PN}-${MY_PV}.x64.tar.gz"
...
S="${PN}-v$(get_major_version)_$(get_version_component_range 2)"
