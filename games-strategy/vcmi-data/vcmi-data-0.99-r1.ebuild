...
DESCRIPTION="Heroes of Might and Magic III game engine core data"
HOMEPAGE="https://vcmi.eu"
MY_P="core"
SRC_URI="
         http://download.vcmi.eu/core.zip    -> ${PN}-core-${PV}.zip
  wog? ( http://download.vcmi.eu/WoG/wog.zip -> ${PN}-wog-${PV}.zip )
"
...
src_install() {
  insinto "${EPREFIX}/usr/share/vcmi"
...
pkg_postinst() {
  ...
  elog "game directory into ${EPREFIX}/usr/share/vcmi."
