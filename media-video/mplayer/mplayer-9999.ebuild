...
#    PATCHES=( "${FILESDIR}"/vaapi-valitale/*.patch )

#    VAAPI_PATCHES="
#	 "${FILESDIR}"/vaapi-valitale/mplayer-vaapi.patch \
#	 "${FILESDIR}"/vaapi-valitale/mplayer-vaapi-gma500-workaround.patch \
#	 "${FILESDIR}"/vaapi-valitale/mplayer-vaapi-0.29.patch \
#	 "${FILESDIR}"/vaapi-valitale/mplayer-vdpau.patch \
#"
    VAAPI_PATCHES="
	 "${FILESDIR}"/vaapi-take3/01-mplayer-vaapi.patch \
	 "${FILESDIR}"/vaapi-take3/02-mplayer-vaapi-gma500-workaround.patch \
	 "${FILESDIR}"/vaapi-take3/03-mplayer-vaapi-0.29.patch \
	 "${FILESDIR}"/vaapi-take3/04-mplayer-vdpau.patch \
"
