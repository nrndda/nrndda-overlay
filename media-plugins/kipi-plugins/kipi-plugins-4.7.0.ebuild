...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/kipi-plugins/kipi-plugins-4.7.0.ebuild,v 1.2 2015/01/29 00:01:15 johu Exp $
...
COMMONDEPEND="
	...
	dev-libs/libxslt
	dev-libs/qjson
	gpssync?	( >=media-libs/libkgeomap-4.7.0 )
	media-libs/libpng:0=
	media-libs/tiff
	virtual/jpeg
...
PATCHES=(
	"${FILESDIR}/${PN}-4.7.0-options.patch"
)
