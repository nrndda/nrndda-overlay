...
src_prepare() {
	##Man-db has no man2html
	#sed -i '/man2html/ s/^/#/' ${S}/doc/Makefile
	sed -i 's/| man2html --pgsize=100000 --bare//' ${S}/doc/Makefile
}
...
src_postints() {
	ewarn "Man-db has no man2html. So html file not properly formated"
}
