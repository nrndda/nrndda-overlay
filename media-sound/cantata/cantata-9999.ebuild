...
HOMEPAGE="https://github.com/nrndda/cantata.git"
...
LICENSE="GPL-2"
SLOT="0"
IUSE="cdda cddb cdio http-server mtp musicbrainz replaygain streaming taglib udisks uchardet zeroconf"
REQUIRED_USE="
	?? ( cdda cdio )
...
src_configure() {
	local mycmakeargs=(
		...
		-DENABLE_UCHARDET=$(usex uchardet)
