...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/digikam/digikam-4.7.0.ebuild,v 1.2 2014/12/21 21:46:01 dilfridge Exp $
...
CDEPEND="
	...
	|| ( >=kde-apps/libkface-14.12.0:4 >=media-libs/libkface-4.7.0 )
	>=media-libs/libkgeomap-4.7.0:=
	media-libs/liblqr
