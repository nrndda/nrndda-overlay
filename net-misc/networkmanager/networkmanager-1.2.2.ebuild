...
src_prepare() {
	...
	epatch "${FILESDIR}"/dlopen_missing_fix.patch
	epatch "${FILESDIR}"/networkmanager-1.2.2-sleep-monitor-upower_include.patch
	epatch "${FILESDIR}"/disable_wifi_scan_when_connected.patch
