...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/usb_modeswitch/usb_modeswitch-1.1.7.ebuild,v 1.1 2011/03/08 00:47:18 rafaelmartins Exp $
...
RDEPEND="${DEPEND}
	!minimal? ( dev-lang/tcl )" # usb_modeswitch script is tcl
