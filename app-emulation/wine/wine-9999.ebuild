...
if [[ ${PV} == "9999" ]] ; then
	...
	EGIT_REPO_URI="git://github.com/ixit/wine.git"
	EGIT_BRANCH="master"
	inherit git-r3
	SRC_URI=""
	#KEYWORDS=""
...
#else
	SRC_URI="${SRC_URI}
	staging? ( https://github.com/wine-compholio/wine-staging/archive/v${STAGING_PV}${SUFFIX}.tar.gz -> ${STAGING_P}.tar.gz )"
#fi
...
src_prepare() {
	...
	if use staging; then
		...
		#local STAGING_EXCLUDE=" -W wined3d-CSMT_Main -W wined3d-CSMT_Helper"
		#local STAGING_EXCLUDE=" -W wined3d-CSMT_Helper -W dxva2-Video_Decoder -W winecfg-Staging -W kernel32-GetFinalPathNameByHandle"
