...
GV="2.34"
MV="4.5.4"
COMPHOLIO_P="wine-staging-1.7.33"
...
src_unpack() {
	...
	use pipelight || use experimental || use pulseaudio && unpack "${COMPHOLIO_P}.tar.gz"
...
src_prepare() {
	...
	use pipelight || local COMPHOLIO_MAKE_ARGS="${COMPHOLIO_MAKE_ARGS} -W fonts-Missing_Fonts.ok"
