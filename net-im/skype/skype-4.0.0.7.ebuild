...
SRC_URI="gtk-static? ( http://download.skype.com/linux/${SFILENAME} )
	!gtk-static? ( http://download.skype.com/linux/${DFILENAME} )"

LICENSE="skype-eula"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="pax_kernel gtk-static"
...
RDEPEND="
	amd64? (
		...
		!gtk-static? ( >=app-emulation/emul-linux-x86-gtklibs-${EMUL_VER} )
		)
	x86? (
...
DEPEND="!gtk-static? ( x11-libs/gtk+:3 )"
