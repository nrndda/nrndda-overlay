...
REQUIRED_USE="
	d3d9?   ( || ( video_cards_iris video_cards_crocus video_cards_r300 video_cards_r600 video_cards_radeonsi video_cards_nouveau video_cards_vmware ) )
	osmesa? ( gallium )
	...
	if use vulkan; then
		if ! use video_cards_freedreno &&
		   ...
		   ! use video_cards_v3d; then
			ewarn "Ignoring USE=vulkan     since VIDEO_CARDS does not contain crocus, freedreno, i965, iris, radeonsi, or v3d"
		fi
	fi
