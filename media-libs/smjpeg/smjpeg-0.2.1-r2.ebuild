...
# $Header: /var/cvsroot/gentoo-x86/media-libs/smjpeg/Attic/smjpeg-0.2.1-r2.ebuild,v 1.18 2009/07/19 17:30:59 ssuominen Exp $
...
multilib_src_configure() {
	# FIXME
	use nas && LDFLAGS="-lXt"
	LDFLAGS="${LDFLAGS}" ECONF_SOURCE="${S}" econf
}
